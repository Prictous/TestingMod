...
public class RockTumblerBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory, ImplementedInventory {
        ...
        this.propertyDelegate = new PropertyDelegate() {
            ...
            public int get(int index) {
                return switch (index) {
                    ...
                    case 1 -> RockTumblerBlockEntity.this.maxProgress;
                    default -> 0;
                };
            }
            ...
            public void set(int index, int value) {
                switch (index) {
                    case 0 -> RockTumblerBlockEntity.this.progress = value;
                    case 1 -> RockTumblerBlockEntity.this.maxProgress = value;
                }
            }
    ...
    public Text getDisplayName() {
        return Text.literal("Rock Tumbler");
    }
    @Override
    ...
    protected void writeNbt(NbtCompound nbt) {
        ...
        nbt.putInt("rock_tumbling.progress", progress);
    }
    ...
    public void readNbt(NbtCompound nbt) {
        ...
        progress = nbt.getInt("rock_tumbling.progress");
    }
